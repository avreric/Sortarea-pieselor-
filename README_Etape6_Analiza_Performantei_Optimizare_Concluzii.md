...
**Link Repository GitHub:** [ https://github.com/avreric/Sortarea-pieselor- ]  
...
Baseline,Configurația inițială (Etapa 5),0.65,0.45,Referință.
Exp 1,Learning Rate: 0.001 → 0.0001,0.68,0.48,Convergență mai lină.
Exp 2,Batch Size: 32 → 16,0.67,0.46,Zgomot mai mare în antrenare.
Exp 3,Adăugare Dropout 0.5,0.70,0.49,Reduce overfitting-ul pe date puține.
Exp 4,Final: Prag 0.60 + Augmentări,0.71,0.50,Cel mai bun echilibru (Best).
...
|----------------|-------------------|------------------------|-----------------|
Componenta,Stare Etapa 5,Modificare Etapa 6,Justificare
Model încărcat,trained_model.h5,model_inspectie_roti_dintate.h5,Acuratețe crescută la 71.43%.
Threshold decizie,0.50 (Default),0.60,Optimizat pentru a elimina complet alarmele false (FP=0).
Interfață UI,Doar verdict,Bară progres + Procent,Transparență pentru operatorul uman.
Data Logging,Oprit,Predicție + Imagine salvată,Audit trail obligatoriu pentru industrie.
...
Metrică,Etapa 5 (Baseline),Etapa 6 (Optimizat),Evoluție,Status Target
Accuracy,0.72,0.81,+9%,
F1-Score,0.68,0.77,+9%,
Latență,48ms,35ms,-13ms,
...
|-------------|-------------|-------------|-------------|----------------------|------------|
Metrică,Etapa 5,Etapa 6 (Final),Target Industrial,Status
Accuracy,65%,71.43%,≥85%,Aproape
F1-score (Defect),0.45,0.50,≥0.80,De îmbunătățit
False Negative Rate,80%,66.67%,≤5%,CRITIC
Alarme False (FP),1,0,≤10%,EXCELENT
Latență inferență,50ms,35ms,≤50ms,OK
